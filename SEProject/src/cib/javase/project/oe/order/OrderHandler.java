...
public class OrderHandler {
    ...
    public static void insertOrder(Order o) {
        ...
        String sql = "INSERT INTO ORDERS" + " (ORDER_DATE, ORDER_TOTAL, CUSTOMER_ID)" + " VALUES(?,?,?)";
        ...
        try {
            ...
            for (OrderItem item : o.getItems()) {
                sql =
                    "INSERT INTO ORDER_ITEMS" + " (ORDER_ITEM_QTY, ORDER_ID, PRODUCT_ID)" +
    ...
    public static Order getOrder(int orderId) {
        String sql = "SELECT ORDER_DATE, ORDER_TOTAL, CUSTOMER_ID" + " FROM ORDERS" + " WHERE ORDER_ID = ?";
        ...
        try {
            ...
            sql = "SELECT ORDER_ITEM_ID, ORDER_ITEM_QTY, PRODUCT_ID" + " FROM ORDER_ITEMS" + " WHERE ORDER_ID = ?";
            ps = conn.prepareStatement(sql);
            ps.setInt(1, orderId);
            rs = ps.executeQuery();
